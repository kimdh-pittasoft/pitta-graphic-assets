...
export interface DarkModeFalse2x2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false@2x-2.png";

export const DarkModeFalse2x2Image: React.FC<DarkModeFalse2x2ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false@2x-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse2x2Image;
