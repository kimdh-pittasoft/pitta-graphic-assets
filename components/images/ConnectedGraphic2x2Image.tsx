...
export interface ConnectedGraphic2x2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@2x-2.png";

export const ConnectedGraphic2x2Image: React.FC<ConnectedGraphic2x2ImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@2x-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic2x2Image;
