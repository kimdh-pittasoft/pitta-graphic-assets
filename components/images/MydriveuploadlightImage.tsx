...
export interface MydriveuploadlightImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "MyDriveUploadLight.png";

export const MydriveuploadlightImage: React.FC<MydriveuploadlightImageProps> = ({
  className,
  width,
  height,
  alt = "MyDriveUploadLight.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default MydriveuploadlightImage;
