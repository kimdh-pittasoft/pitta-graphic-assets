...
export interface ConnectedGraphic2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@2x.png";

export const ConnectedGraphic2xImage: React.FC<ConnectedGraphic2xImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic2xImage;
