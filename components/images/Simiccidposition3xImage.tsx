...
export interface Simiccidposition3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIMICCIDPosition@3x.png";

export const Simiccidposition3xImage: React.FC<Simiccidposition3xImageProps> = ({
  className,
  width,
  height,
  alt = "SIMICCIDPosition@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Simiccidposition3xImage;
