...
export interface Cm100glteImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "CM100GLTE.png";

export const Cm100glteImage: React.FC<Cm100glteImageProps> = ({
  className,
  width,
  height,
  alt = "CM100GLTE.png",
