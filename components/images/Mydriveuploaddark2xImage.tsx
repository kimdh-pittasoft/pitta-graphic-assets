...
export interface Mydriveuploaddark2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "MyDriveUploadDark@2x.png";

export const Mydriveuploaddark2xImage: React.FC<Mydriveuploaddark2xImageProps> = ({
  className,
  width,
  height,
  alt = "MyDriveUploadDark@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Mydriveuploaddark2xImage;
