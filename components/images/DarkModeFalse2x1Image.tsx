...
export interface DarkModeFalse2x1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false@2x-1.png";

export const DarkModeFalse2x1Image: React.FC<DarkModeFalse2x1ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false@2x-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse2x1Image;
