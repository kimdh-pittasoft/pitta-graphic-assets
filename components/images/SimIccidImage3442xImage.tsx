...
export interface SimIccidImage3442xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIM ICCID image - 344@2x.png";

export const SimIccidImage3442xImage: React.FC<SimIccidImage3442xImageProps> = ({
  className,
  width,
  height,
  alt = "SIM ICCID image - 344@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimIccidImage3442xImage;
