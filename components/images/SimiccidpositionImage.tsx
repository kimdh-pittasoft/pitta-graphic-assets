...
export interface SimiccidpositionImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIMICCIDPosition.png";

export const SimiccidpositionImage: React.FC<SimiccidpositionImageProps> = ({
  className,
  width,
  height,
  alt = "SIMICCIDPosition.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimiccidpositionImage;
