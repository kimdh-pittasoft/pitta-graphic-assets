...
export interface SimIccidImage344ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIM ICCID image - 344.png";

export const SimIccidImage344Image: React.FC<SimIccidImage344ImageProps> = ({
  className,
  width,
  height,
  alt = "SIM ICCID image - 344.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimIccidImage344Image;
