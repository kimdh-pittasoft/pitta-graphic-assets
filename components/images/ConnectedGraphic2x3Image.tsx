...
export interface ConnectedGraphic2x3ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@2x-3.png";

export const ConnectedGraphic2x3Image: React.FC<ConnectedGraphic2x3ImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@2x-3.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic2x3Image;
