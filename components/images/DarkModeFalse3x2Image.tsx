...
export interface DarkModeFalse3x2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false@3x-2.png";

export const DarkModeFalse3x2Image: React.FC<DarkModeFalse3x2ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false@3x-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse3x2Image;
