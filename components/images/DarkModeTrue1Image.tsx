...
export interface DarkModeTrue1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true-1.png";

export const DarkModeTrue1Image: React.FC<DarkModeTrue1ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue1Image;
