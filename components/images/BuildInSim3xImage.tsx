...
export interface BuildInSim3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Build-in SIM@3x.png";

export const BuildInSim3xImage: React.FC<BuildInSim3xImageProps> = ({
  className,
  width,
  height,
  alt = "Build-in SIM@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default BuildInSim3xImage;
