...
export interface ConnectedGraphic3x3ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@3x-3.png";

export const ConnectedGraphic3x3Image: React.FC<ConnectedGraphic3x3ImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@3x-3.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic3x3Image;
