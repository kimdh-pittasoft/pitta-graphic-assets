...
export interface LiveeventuploaddarkImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "LiveEventUploadDark.png";

export const LiveeventuploaddarkImage: React.FC<LiveeventuploaddarkImageProps> = ({
  className,
  width,
  height,
  alt = "LiveEventUploadDark.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default LiveeventuploaddarkImage;
