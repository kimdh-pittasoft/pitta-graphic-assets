...
export interface ConnectedGraphic3x2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@3x-2.png";

export const ConnectedGraphic3x2Image: React.FC<ConnectedGraphic3x2ImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@3x-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic3x2Image;
