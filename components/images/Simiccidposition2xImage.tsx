...
export interface Simiccidposition2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIMICCIDPosition@2x.png";

export const Simiccidposition2xImage: React.FC<Simiccidposition2xImageProps> = ({
  className,
  width,
  height,
  alt = "SIMICCIDPosition@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Simiccidposition2xImage;
