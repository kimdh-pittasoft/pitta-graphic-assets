...
export interface DarkModeTrue3x1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true@3x-1.png";

export const DarkModeTrue3x1Image: React.FC<DarkModeTrue3x1ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true@3x-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue3x1Image;
