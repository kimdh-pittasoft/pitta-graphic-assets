...
export interface SimIccidImage3452xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIM ICCID image - 345@2x.png";

export const SimIccidImage3452xImage: React.FC<SimIccidImage3452xImageProps> = ({
  className,
  width,
  height,
  alt = "SIM ICCID image - 345@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimIccidImage3452xImage;
