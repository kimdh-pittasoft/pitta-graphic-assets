...
export interface ConnectedGraphic2x1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@2x-1.png";

export const ConnectedGraphic2x1Image: React.FC<ConnectedGraphic2x1ImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@2x-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic2x1Image;
