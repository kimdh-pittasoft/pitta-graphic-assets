...
export interface WifiHotspot3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "WiFI Hotspot@3x.png";

export const WifiHotspot3xImage: React.FC<WifiHotspot3xImageProps> = ({
  className,
  width,
  height,
  alt = "WiFI Hotspot@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default WifiHotspot3xImage;
