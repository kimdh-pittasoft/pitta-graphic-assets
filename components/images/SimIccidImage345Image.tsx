...
export interface SimIccidImage345ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIM ICCID image - 345.png";

export const SimIccidImage345Image: React.FC<SimIccidImage345ImageProps> = ({
  className,
  width,
  height,
  alt = "SIM ICCID image - 345.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimIccidImage345Image;
