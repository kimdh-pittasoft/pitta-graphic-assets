...
export interface ConnectedGraphic3x1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@3x-1.png";

export const ConnectedGraphic3x1Image: React.FC<ConnectedGraphic3x1ImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@3x-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic3x1Image;
