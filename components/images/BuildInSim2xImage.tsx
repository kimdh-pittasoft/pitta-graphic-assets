...
export interface BuildInSim2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Build-in SIM@2x.png";

export const BuildInSim2xImage: React.FC<BuildInSim2xImageProps> = ({
  className,
  width,
  height,
  alt = "Build-in SIM@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default BuildInSim2xImage;
