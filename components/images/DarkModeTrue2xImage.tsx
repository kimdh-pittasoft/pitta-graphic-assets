...
export interface DarkModeTrue2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true@2x.png";

export const DarkModeTrue2xImage: React.FC<DarkModeTrue2xImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue2xImage;
