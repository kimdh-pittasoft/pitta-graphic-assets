...
export interface DarkModeTrue3x2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true@3x-2.png";

export const DarkModeTrue3x2Image: React.FC<DarkModeTrue3x2ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true@3x-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue3x2Image;
