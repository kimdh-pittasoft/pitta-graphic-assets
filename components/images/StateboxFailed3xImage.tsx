...
export interface StateboxFailed3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "state=Box - Failed@3x.png";

export const StateboxFailed3xImage: React.FC<StateboxFailed3xImageProps> = ({
  className,
  width,
  height,
  alt = "state=Box - Failed@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default StateboxFailed3xImage;
