...
export interface DarkModeFalse2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false@2x.png";

export const DarkModeFalse2xImage: React.FC<DarkModeFalse2xImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse2xImage;
