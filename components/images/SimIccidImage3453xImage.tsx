...
export interface SimIccidImage3453xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIM ICCID image - 345@3x.png";

export const SimIccidImage3453xImage: React.FC<SimIccidImage3453xImageProps> = ({
  className,
  width,
  height,
  alt = "SIM ICCID image - 345@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimIccidImage3453xImage;
