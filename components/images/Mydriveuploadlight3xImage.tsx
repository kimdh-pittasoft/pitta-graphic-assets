...
export interface Mydriveuploadlight3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "MyDriveUploadLight@3x.png";

export const Mydriveuploadlight3xImage: React.FC<Mydriveuploadlight3xImageProps> = ({
  className,
  width,
  height,
  alt = "MyDriveUploadLight@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Mydriveuploadlight3xImage;
