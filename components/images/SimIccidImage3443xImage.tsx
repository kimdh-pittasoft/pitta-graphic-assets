...
export interface SimIccidImage3443xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "SIM ICCID image - 344@3x.png";

export const SimIccidImage3443xImage: React.FC<SimIccidImage3443xImageProps> = ({
  className,
  width,
  height,
  alt = "SIM ICCID image - 344@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default SimIccidImage3443xImage;
