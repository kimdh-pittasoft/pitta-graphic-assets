...
export interface DarkModeFalseImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false.png";

export const DarkModeFalseImage: React.FC<DarkModeFalseImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalseImage;
