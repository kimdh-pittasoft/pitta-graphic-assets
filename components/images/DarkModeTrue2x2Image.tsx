...
export interface DarkModeTrue2x2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true@2x-2.png";

export const DarkModeTrue2x2Image: React.FC<DarkModeTrue2x2ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true@2x-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue2x2Image;
