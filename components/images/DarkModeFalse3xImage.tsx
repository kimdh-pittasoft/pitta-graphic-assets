...
export interface DarkModeFalse3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false@3x.png";

export const DarkModeFalse3xImage: React.FC<DarkModeFalse3xImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse3xImage;
