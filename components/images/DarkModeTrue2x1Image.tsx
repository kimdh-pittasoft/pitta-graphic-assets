...
export interface DarkModeTrue2x1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true@2x-1.png";

export const DarkModeTrue2x1Image: React.FC<DarkModeTrue2x1ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true@2x-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue2x1Image;
