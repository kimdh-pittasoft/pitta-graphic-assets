...
export interface DarkModeTrue2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true-2.png";

export const DarkModeTrue2Image: React.FC<DarkModeTrue2ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue2Image;
