...
export interface DarkModeFalse1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false-1.png";

export const DarkModeFalse1Image: React.FC<DarkModeFalse1ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse1Image;
