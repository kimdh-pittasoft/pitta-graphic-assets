...
export interface StateboxFailed2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "state=Box - Failed@2x.png";

export const StateboxFailed2xImage: React.FC<StateboxFailed2xImageProps> = ({
  className,
  width,
  height,
  alt = "state=Box - Failed@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default StateboxFailed2xImage;
