...
export interface DarkModeFalse2ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false-2.png";

export const DarkModeFalse2Image: React.FC<DarkModeFalse2ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false-2.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse2Image;
