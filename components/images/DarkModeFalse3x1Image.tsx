...
export interface DarkModeFalse3x1ImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=false@3x-1.png";

export const DarkModeFalse3x1Image: React.FC<DarkModeFalse3x1ImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=false@3x-1.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeFalse3x1Image;
