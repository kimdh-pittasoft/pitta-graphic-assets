...
export interface Mydriveuploadlight2xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "MyDriveUploadLight@2x.png";

export const Mydriveuploadlight2xImage: React.FC<Mydriveuploadlight2xImageProps> = ({
  className,
  width,
  height,
  alt = "MyDriveUploadLight@2x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Mydriveuploadlight2xImage;
