...
export interface FleetadriveuploaddarkImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "FleetaDriveUploadDark.png";

export const FleetadriveuploaddarkImage: React.FC<FleetadriveuploaddarkImageProps> = ({
  className,
  width,
  height,
  alt = "FleetaDriveUploadDark.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default FleetadriveuploaddarkImage;
