...
export interface DarkModeTrue3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true@3x.png";

export const DarkModeTrue3xImage: React.FC<DarkModeTrue3xImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrue3xImage;
