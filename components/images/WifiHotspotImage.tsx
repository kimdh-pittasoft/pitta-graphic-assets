...
export interface WifiHotspotImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "WiFI Hotspot.png";

export const WifiHotspotImage: React.FC<WifiHotspotImageProps> = ({
  className,
  width,
  height,
  alt = "WiFI Hotspot.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default WifiHotspotImage;
