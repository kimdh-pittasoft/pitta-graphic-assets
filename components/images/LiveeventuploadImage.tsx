...
export interface LiveeventuploadImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "LiveEventUpload.png";

export const LiveeventuploadImage: React.FC<LiveeventuploadImageProps> = ({
  className,
  width,
  height,
  alt = "LiveEventUpload.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default LiveeventuploadImage;
