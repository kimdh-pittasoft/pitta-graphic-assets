...
export interface Mydriveuploaddark3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "MyDriveUploadDark@3x.png";

export const Mydriveuploaddark3xImage: React.FC<Mydriveuploaddark3xImageProps> = ({
  className,
  width,
  height,
  alt = "MyDriveUploadDark@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Mydriveuploaddark3xImage;
