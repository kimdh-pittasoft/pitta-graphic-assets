...
export interface DarkModeTrueImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "dark mode_=true.png";

export const DarkModeTrueImage: React.FC<DarkModeTrueImageProps> = ({
  className,
  width,
  height,
  alt = "dark mode_=true.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default DarkModeTrueImage;
