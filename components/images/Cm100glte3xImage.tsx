...
export interface Cm100glte3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "CM100GLTE@3x.png";

export const Cm100glte3xImage: React.FC<Cm100glte3xImageProps> = ({
  className,
  width,
  height,
  alt = "CM100GLTE@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default Cm100glte3xImage;
