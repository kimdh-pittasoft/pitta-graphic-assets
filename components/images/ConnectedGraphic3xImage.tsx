...
export interface ConnectedGraphic3xImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "Connected Graphic@3x.png";

export const ConnectedGraphic3xImage: React.FC<ConnectedGraphic3xImageProps> = ({
  className,
  width,
  height,
  alt = "Connected Graphic@3x.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default ConnectedGraphic3xImage;
