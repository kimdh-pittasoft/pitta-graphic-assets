...
export interface MydriveuploaddarkImageProps {
  className?: string;
  width?: number | string;
...
const imagePath = "MyDriveUploadDark.png";

export const MydriveuploaddarkImage: React.FC<MydriveuploaddarkImageProps> = ({
  className,
  width,
  height,
  alt = "MyDriveUploadDark.png",
  style,
  onClick,
  onLoad,
  onError,
...
export default MydriveuploaddarkImage;
